...
import utility.ClassTableModelDonChiTiet;
import utility.ClassTableModelDonHang;
import view.DonChiTietFrame;
import view.DonHangFrame;


public class DonChiTietDSController {
    ...
    private ClassTableModelDonChiTiet classTableModelDonChiTiet = null;

    private final String[] COLUMNS = {"STT", "Mã đơn", "Mã sản phẩm", "Số lượng", 
        "Tổng tiền"};
    ...
    public DonChiTietDSController(JPanel jpnView, JButton btnAdd, JTextField jtfSearch, JButton btnUpdate) {
        this.jpnView = jpnView;
        this.btnAdd = btnAdd;
        this.jtfSearch = jtfSearch;
        this.btnUpdate = btnUpdate;
        this.classTableModelDonChiTiet = new ClassTableModelDonChiTiet();

        this.donChiTietService = new DonChiTietService();
    }

    public void setDataToTable() {
        List<DonChiTiet> listItem = donChiTietService.getList();
        DefaultTableModel model = classTableModelDonChiTiet.setTableDonChiTiet(listItem, COLUMNS);
...
//        table.setAutoCreateRowSorter(true);
      ...
      public void mouseClicked(MouseEvent e) {
             if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    donChiTiet.setId_don((int) model.getValueAt(selectedRowIndex, 1));
                    donChiTiet.setId_sp((int) model.getValueAt(selectedRowIndex, 2));
                    donChiTiet.setSo_luong((int) model.getValueAt(selectedRowIndex, 3));
                    donChiTiet.setTong_tien((long) model.getValueAt(selectedRowIndex, 4));
...
//        jpnView.setAlignmentX(0);
    ...
    public void setEvent() {
        btnAdd.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent e) {
                new DonChiTietFrame(new DonChiTiet()).setVisible(true);
