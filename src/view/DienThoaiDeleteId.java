 ...
 * @author ADMIN
 */
public class DienThoaiDeleteId extends javax.swing.JFrame {

    /**
     * Creates new form KhachHangDelete
     */
    public DienThoaiDeleteId() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlbId.setText("Chọn ID khách muốn xóa:");
    ...
    private void jbtXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtXoaActionPerformed
        ...
        else
        {
            ...
            int res = dienThoaiService.deleteById(text);
            if(res == 1)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DienThoaiDeleteId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
