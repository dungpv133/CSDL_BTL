 ...
 * @author ADMIN
 */
public class SanPhamDelete extends javax.swing.JFrame {

    /**
     * Creates new form KhachHangDelete
     */
    public SanPhamDelete() {
        initComponents();
        setTitle("Xóa thông tin sản phẩm");
    ...
    private void initComponents() {
        ...
        jlbId.setText("Chọn ID sản phẩm muốn xóa:");
    ...
    private void jbtXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtXoaActionPerformed
        ...
        else
        {
            ...
            int res = sanPhamService.deleteById(text);
            if(res == 1)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SanPhamDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
