 ...
 * @author ADMIN
 */
public class DienThoaiDeleteSDT extends javax.swing.JFrame {

    /**
     * Creates new form KhachHangDelete
     */
    public DienThoaiDeleteSDT() {
        initComponents();
        setTitle("Xóa số điện thoại theo ID khách");
    ...
    private void initComponents() {
        ...
        jlbId.setFont(new java.awt.Font("Arial", 0, 17)); // NOI18N
        jlbId.setText("Chọn số điiện thoại  muốn xóa:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jtxtXoa, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE))
                .addGap(96, 96, 96)
    ...
    private void jbtXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtXoaActionPerformed
        ...
        else
        {
            ...
            String text = (jtxtXoa.getText());
            int res = dienThoaiService.deleteBySDT(text);
            if(res == 1)
            {
            ...
            {
                jlbId.setText("Không tìm thấy số điện thoại cần xóa!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DienThoaiDeleteSDT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
