 ...
 * @author ADMIN
 */
public class DonHangDelete extends javax.swing.JFrame {

    /**
     * Creates new form KhachHangDelete
     */
    public DonHangDelete() {
        initComponents();
        setTitle("Xóa thông tin đơn hàng");
    ...
    private void initComponents() {
        ...
        jlbId.setText("Chọn ID đơn hàng muốn xóa:");
    ...
    private void jbtXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtXoaActionPerformed
        ...
        else
        {
            ...
            int res = donHangService.deleteById(text);
            if(res == 1)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonHangDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
